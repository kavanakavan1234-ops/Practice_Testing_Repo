...
export class  EmailValidationForm {
  ...
  async clickDownload() {
   // await this.page.getByRole('button', { name: 'Email Schedule' }).click();
   await this.page.getByText('Schedules', { exact: true }).click();
   await this.page.locator('#schedule0').getByText('Email Schedule').click();
